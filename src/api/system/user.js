...
export const userDeptAuthDetails = (params) => {
  return request({
    url: '/api/iot-system/user/teacher/dept/auth/details',
    method: 'get',
    params: {
      ...params
    }
...
export const userDeptAuthSubmit = (row) => {
  return request({
    url: '/api/iot-system/user/teacher/dept/auth',
    method: 'post',
    data:row
  })
}