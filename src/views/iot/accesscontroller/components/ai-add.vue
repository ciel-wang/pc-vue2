<template>
  <span>
    ...
    <el-dialog title="添加人脸设备"
               append-to-body
               :visible.sync="boxShow"
               width="900px"
                :before-close="handleClose" >
      <avue-form ref="avueform" :option="option" v-model="obj" @submit="submit">
...
<script>
  import {addFace} from "@/api/iot/access/face";
  ...
  export default {
    ...
    data() {
      return {
        areaTreeData:[],
        boxShow:false,
        obj:{attendance:false,isPushMsg:false,devType:7,devState:1},
      };
    },
    computed:{
        ...
        permissionList() {
            return {
                addBtn: this.vaildData(this.permission.access_controller_equipment_ai_add_btn, false),
           }
       },
      option(){
        return {
