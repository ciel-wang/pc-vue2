      ...
      <template slot="qjspHeader">
        <div>
          ...
          <el-tooltip class="item" effect="dark" placement="top-start">
            <div slot="content" style="width: 230px;">学校可限制教职工发起补卡申请的次数。</div>
...
export default {
  data() {
    return {
      title: '添加补卡类型',
      drawerVisible: false,
      form: { ranks: [{ operator: '>', auditRank: '一级', limitDays: 1 }] }
    };
  },
  watch: {
    'form.ranks': {
        ...
        group:[
          {
            ...
            column:[
              {
                label: "每月最多允许补卡次数",
                prop: "BK_EMP_MONTH_BK_MAX_COUNT",
                span:24,
                labelWidth:'160',
                controls:false,
                type:'number',
